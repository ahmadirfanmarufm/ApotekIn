      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              ...
              >
                {isCritical ? "Stok Kritis" : "Stok Normal"}
              </span>
            </div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <div className="rounded-xl bg-slate-50 p-3">
            <p className="text-xs text-slate-400">Batch Aktif</p>
          ...
          <div className="rounded-xl bg-slate-50 p-3">
            <p className="text-xs text-slate-400">Exp. Terdekat</p>
        ...
        {nearestBatch && (
          <div className="mt-4 rounded-xl border border-emerald-100 bg-emerald-50/50 p-4">
            ...
            <div className="mt-3 flex items-center justify-between text-xs">
              <span className="text-slate-400">Stok batch</span>

              <span className="font-semibold text-slate-700">
                {nearestBatch.quantity.toLocaleString("id-ID")} {item.unit}
              </span>
            </div>
          </div>
        )}
