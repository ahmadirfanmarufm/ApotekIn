    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-3 sm:p-4">
      <div className="bg-white rounded-2xl w-full max-w-5xl shadow-xl overflow-hidden flex flex-col max-h-[95vh] sm:max-h-[90vh]">
          ...
          <div>
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center mb-4">
              ...
              <button
                ...
                className="text-emerald-600 text-sm font-semibold hover:text-emerald-700 flex items-center gap-1 cursor-pointer self-start sm:self-auto"
              >
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-center mt-4 sm:pr-2">
              <p className="text-xs text-slate-400 order-2 sm:order-1">
                Urutan batch mengikuti FEFO (First Expired First Out).
              </p>
              <div className="text-sm font-bold text-slate-900 order-1 sm:order-2">
        ...
        <div className="px-4 py-4 sm:px-6 border-t border-slate-200 flex flex-col-reverse sm:flex-row sm:justify-end items-stretch sm:items-center gap-3 bg-white">
          ...
          <button
            onClick={onClose}
            className="px-6 py-2.5 border border-slate-300 text-slate-700 rounded-xl font-medium hover:bg-slate-50 transition-colors w-full sm:w-auto cursor-pointer"
          >
            Batal
          </button>
          <button
            ...
            className="px-6 py-2.5 bg-emerald-500 text-white rounded-xl font-medium hover:bg-emerald-600 transition-colors w-full sm:w-48 disabled:opacity-50 cursor-pointer"
          >
            {isSubmitting ? (
