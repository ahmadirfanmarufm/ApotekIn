...
export function POModal({ isOpen, onClose }: POModalProps) {
    const [items, setItems] = useState([
        { id: 1, name: 'Paracetamol 500mg', qty: 0, unit: 'Gram' }
    ]);
                ...
                <div className="p-6 space-y-8 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-2 gap-6 p-5 border border-slate-200 rounded-xl bg-slate-50/50">
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-slate-600">Nomor PO</label>
                            <select className="w-full border border-slate-200 rounded-lg px-4 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500">
                                <option>-- Pilih PO --</option>
                                <option>PO-2026-0811</option>
                            </select>
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-slate-600">Pilih Supplier</label>
                            <input
                                type="text"
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="font-bold text-slate-900">Daftar Pesanan Barang</h3>
                        ...
                        <div className="border border-slate-200 rounded-xl overflow-hidden">
                            <table className="w-full text-left">
                                <thead className="bg-slate-50 border-b border-slate-200 text-xs uppercase font-bold text-slate-600">
                                    <tr>
                                        <th className="p-4 w-1/2">Pilih Barang</th>
