                ...
                <div className="flex min-w-0 items-start gap-4">
                    ...
                    <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                            <h1 className="font-manrope text-2xl font-bold text-slate-950 sm:text-3xl">
                                {item.name}
                            </h1>
            ...
            <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
                ...
                <div className="rounded-2xl border border-amber-100 bg-amber-50/60 p-6">
                    ...
                    <p className="mt-4 text-sm leading-6 text-slate-600">
                        Gunakan bahan dengan tanggal kedaluwarsa
                        paling dekat terlebih dahulu untuk
                        mengurangi risiko bahan terbuang.
                    </p>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="mt-2 space-y-1 text-sm leading-6 text-red-600">
                                {critical && (
                                    <p>
                                        • Stok bahan berada pada
                                        atau di bawah batas minimum.
                                    </p>
                                )}

                                {nearExpiryCount > 0 && (
                                    <p>
                                        • Ada {nearExpiryCount} batch
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-400">
                            Urutan bahan berdasarkan tanggal
                            kedaluwarsa untuk membantu FEFO.
                        </p>
                    </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                <div className="flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-400">
                            Penggunaan bahan untuk proses racikan
